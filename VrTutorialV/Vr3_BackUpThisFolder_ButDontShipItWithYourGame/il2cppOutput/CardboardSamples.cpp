...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void ObjectController_Update_m9865F8E75DF1A34F5CF4DADACA7FE06B9700BC3A (ObjectController_tBF20F280367D206F28C7FA39CEA13EC3DEA90A87* __this, const RuntimeMethod* method) 
{
	{
		// if(poderodar == true){
		bool L_0 = __this->___poderodar_10;
		if (!L_0)
		{
			goto IL_0029;
		}
	}
	{
		...
		NullCheck(L_1);
		Transform_Rotate_m7EA47AD57F43D478CCB0523D179950EE49CDA3E2(L_1, (0.0f), ((float)il2cpp_codegen_multiply((20.0f), L_2)), (0.0f), NULL);
		return;
	}
...
IL_0029:
	{
		...
		NullCheck(L_3);
		Transform_Rotate_m7EA47AD57F43D478CCB0523D179950EE49CDA3E2(L_3, (0.0f), (0.0f), (0.0f), NULL);
		// }
		return;
	}
}
