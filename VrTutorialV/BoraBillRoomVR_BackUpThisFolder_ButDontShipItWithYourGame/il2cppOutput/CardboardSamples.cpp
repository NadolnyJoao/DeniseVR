...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void ObjectController_Start_m70FD9C9C78F6AD00454583F6B2EFD50D44EB7F6C (ObjectController_tBF20F280367D206F28C7FA39CEA13EC3DEA90A87* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		__this->____startingPosition_8 = L_2;
		...
		__this->____myRenderer_7 = L_3;
		Il2CppCodeGenWriteBarrier((void**)(&__this->____myRenderer_7), (void*)L_3);
		// SetMaterial(false);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void ObjectController_Update_m9865F8E75DF1A34F5CF4DADACA7FE06B9700BC3A (ObjectController_tBF20F280367D206F28C7FA39CEA13EC3DEA90A87* __this, const RuntimeMethod* method) 
{
	{
		// if (podeFlutuar == true){
		bool L_0 = __this->___podeFlutuar_13;
		if (!L_0)
		{
			goto IL_0052;
		}
	...
	{
		// tempPos = posOffset;
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_1 = __this->___posOffset_9;
		__this->___tempPos_10 = L_1;
		// tempPos.y += Mathf.Sin(Time.fixedTime * Mathf.PI * frequency) * amplitude;
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2* L_2 = (&__this->___tempPos_10);
		float* L_3 = (&L_2->___y_3);
		float* L_4 = L_3;
		float L_5 = *((float*)L_4);
		float L_6;
		L_6 = Time_get_fixedTime_mEEDC1E90FA9C17F861872AF08459C04A6BBFCC21(NULL);
		float L_7 = __this->___frequency_12;
		float L_8;
		L_8 = sinf(((float)il2cpp_codegen_multiply(((float)il2cpp_codegen_multiply(L_6, (3.14159274f))), L_7)));
		float L_9 = __this->___amplitude_11;
		*((float*)L_4) = (float)((float)il2cpp_codegen_add(L_5, ((float)il2cpp_codegen_multiply(L_8, L_9))));
		// transform.position = tempPos;
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_10;
		L_10 = Component_get_transform_m2919A1D81931E6932C7F06D4C2F0AB8DDA9A5371(__this, NULL);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_11 = __this->___tempPos_10;
		NullCheck(L_10);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void ObjectController_OnPointerEnter_m56EAD26415A4F4CB49CD6C8E2F22EECF3EF37FDA (ObjectController_tBF20F280367D206F28C7FA39CEA13EC3DEA90A87* __this, const RuntimeMethod* method) 
{
	{
		// poderodar = true;
		__this->___poderodar_6 = (bool)1;
		// podeFlutuar = true;
		__this->___podeFlutuar_13 = (bool)1;
		// }
		return;
	}
}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void ObjectController_OnPointerExit_mF865AD766D6CADC9F24B1BDF35CE6665D85C1C82 (ObjectController_tBF20F280367D206F28C7FA39CEA13EC3DEA90A87* __this, const RuntimeMethod* method) 
{
	{
		// poderodar = false;
		__this->___poderodar_6 = (bool)0;
		// podeFlutuar = false;
		__this->___podeFlutuar_13 = (bool)0;
		// }
		return;
	}
}
...
{
	{
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_0 = __this->___BoraBill_14;
		NullCheck(L_0);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void ObjectController_SetMaterial_m105DB6596A27C0A104B9BD3D4653FE01B323189C (ObjectController_tBF20F280367D206F28C7FA39CEA13EC3DEA90A87* __this, bool ___0_gazedAt, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		Renderer_t320575F223BCB177A982E5DDB5DB19FAA89E7FBF* L_4 = __this->____myRenderer_7;
...
{
	{
		...
		__this->___amplitude_11 = (0.5f);
		// public float frequency = 1f;
		__this->___frequency_12 = (1.0f);
		MonoBehaviour__ctor_m592DB0105CA0BC97AA1C5F4AD27B12D68A3B7C1E(__this, NULL);
		return;
	}
}
